...
@section('css')
    <link rel="stylesheet" href="{{ AdminWeb() }}lib/webuploader/0.1.5/webuploader.css">
    <style>
        .imgbox {
            width: 200px;
            height: 150px;
...
@section('js')
    <!-- 引入 ueditor js类库 -->
    <script type="text/javascript" src="{{ AdminWeb() }}lib/ueditor/1.4.3/ueditor.config.js"></script>
    <script type="text/javascript" src="{{ AdminWeb() }}lib/ueditor/1.4.3/ueditor.all.min.js"></script>
    <script type="text/javascript" src="{{ AdminWeb() }}lib/ueditor/1.4.3/lang/zh-cn/zh-cn.js"></script>
    <!-- 引入webuploader插件 类库JS-->
    <script type="text/javascript" src="{{ AdminWeb() }}lib/webuploader/0.1.5/webuploader.min.js"></script>
    <!-- 表单前端验证插件 jquery validate -->
    <script type="text/javascript" src="{{ AdminWeb() }}lib/jquery.validation/1.14.0/jquery.validate.js"></script>
    <script type="text/javascript" src="{{ AdminWeb() }}lib/jquery.validation/1.14.0/validate-methods.js"></script>
    <script type="text/javascript" src="{{ AdminWeb() }}lib/jquery.validation/1.14.0/messages_zh.js"></script>
    ...
    <script>
       ...
       * @param src 封面地址
       */
      /*async function delpic(id, src) {
        let ret = await $.get('{{ route("admin.article.delfile") }}', {id, src});
        console.log(ret);
      }*/
      ...
      var uploader = WebUploader.create({
        ...
        auto: true,
        // swf文件路径
        swf: '{{ AdminWeb() }}lib/webuploader/0.1.5/Uploader.swf',
        // 文件接收服务端
